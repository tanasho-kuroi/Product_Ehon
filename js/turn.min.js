...
(function (f) {
  ...
  function l(a, b, c, d) {
    return {
      css: { position: 'absolute', top: a, left: b, overflow: d || 'hidden', zIndex: c || 'auto' },
    };
  }
  ...
  var z,
    ...
    g = {
      ...
      _updateShadow: function () {
        ...
        a = this.turn('view');
        c.shadow ||
          (c.shadow = f('<div />', { class: 'shadow', css: l(0, 0, 0).css }).appendTo(this));
    ...
    i = {
      init: function (a) {
        this.data({
          f: { disabled: !1, hover: !1, effect: this.hasClass('hard') ? 'hard' : 'sheet' },
        });
        this.flip('options', a);
      ...
      _fold: function (a) {
        ...
        switch (b.effect) {
          case 'hard':
            ...
            b.wrapper.transform(
              'rotateY(' + r + 'deg)translate3d(0px, 0px, ' + (this.attr('depth') || 0) + 'px)',
              k
            );
            b.fpage.transform('translateX(' + e + 'px) rotateY(' + (180 + r) + 'deg)', x);
            b.parent.css(q);
            t
              ? ((p = -p + 1), b.wrapper.css({ zIndex: l + 1 }), b.fpage.css({ zIndex: l }))
              : ((p -= 1), b.wrapper.css({ zIndex: l }), b.fpage.css({ zIndex: l + 1 }));
            c.opts.gradients &&
              (g
                ? b.ashadow
                    .css({ display: '', left: f, backgroundColor: 'rgba(0,0,0,' + 0.5 * p + ')' })
          ...
          case 'sheet':
            ...
            var O = c.opts.acceleration,
              ...
              I = function () {
                ...
                if (
                  ...
                  return (
                    (a.y = Math.sqrt(Math.pow(h, 2) + 2 * f.x * b.x)), E && (a.y = h - a.y), I()
                  );
                g > L &&
                  ((b = K - g),
                  (f = R - h / Math.sin(b)),
            ...
            f = function (a, d, f, g) {
              ...
              b.fpage
                ...
                .transform(
                  G(g) +
                    F(a.x + Q.x - v.x - (e * f[0]) / 100, a.y + Q.y - v.y - (h * f[1]) / 100, O) +
                    G((180 / g - 2) * g),
                  s
                );
